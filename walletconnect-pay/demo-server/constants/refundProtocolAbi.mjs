export const REFUND_PROTOCOL_ABI = [
  {
    inputs: [
  ...
  { inputs: [], name: "LockupSecondsExceedsMax", type: "error" },
  { inputs: [], name: "MismatchedEarlyWithdrawalArrays", type: "error" },
  {
  ...
  { inputs: [], name: "PaymentDoesNotBelongToRecipient", type: "error" },
  {
    inputs: [{ internalType: "uint256", name: "paymentID", type: "uint256" }],
    name: "PaymentIsStillLocked",
    type: "error",
  },
  {
    inputs: [{ internalType: "uint256", name: "paymentID", type: "uint256" }],
  ...
  { inputs: [], name: "WithdrawalHashAlreadyUsed", type: "error" },
  { inputs: [], name: "WithdrawalHashExpired", type: "error" },
  ...
  },
  {
    ...
    inputs: [
      ...
      },
      {
        indexed: false,
        internalType: "uint256",
        name: "refundExpiryTimestamp",
        type: "uint256",
      },
      {
        indexed: false,
        internalType: "bytes32",
        name: "wcPaymentIdHash",
        type: "bytes32",
      },
    ],
    name: "PaymentCreated",
  ...
  {
    inputs: [],
    name: "EARLY_WITHDRAWAL_TYPEHASH",
    outputs: [{ internalType: "bytes32", name: "", type: "bytes32" }],
    stateMutability: "view",
    type: "function",
  },
  ...
  },
  {
    ...
    outputs: [
      { internalType: "address", name: "to", type: "address" },
      { internalType: "uint256", name: "amount", type: "uint256" },
      { internalType: "uint256", name: "releaseTimestamp", type: "uint256" },
      { internalType: "address", name: "refundTo", type: "address" },
  ...
  },
  {
    inputs: [
      ...
      {
        internalType: "uint256",
        name: "recipientLockupSeconds",
        type: "uint256",
      },
    ],
    name: "setLockupSeconds",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
  },
  ...
  },
  {
    inputs: [
      { internalType: "uint256", name: "paymentID", type: "uint256" },
      { internalType: "address", name: "newRefundTo", type: "address" },
    ],
    name: "updateRefundTo",
    outputs: [],
    stateMutability: "nonpayable",
