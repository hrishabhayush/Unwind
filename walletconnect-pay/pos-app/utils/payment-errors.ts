...
const ERROR_MESSAGES: Record<string, PaymentErrorMessage> = {
  ...
  failed: {
    title: "Payment was declined or failed",
    subtitle:
      "The payer wallet rejected the transaction, funds were insufficient, or the network could not confirm the payment. Try again or use another wallet or chain.",
  },
};
